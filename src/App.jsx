...
import img4 from './assets/bg-showcase-1.jpg';
import img5 from './assets/bg-showcase-2.jpg';
import img6 from './assets/bg-showcase-3.jpg';
import img7 from './assets/bg-masthead.jpg';
import img8 from './assets/bg-masthead.jpg';
function App() {
  ...
  <Navbar/>
         ...
         <section className="showcase">
            <div className="container-fluid p-0">
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url(${img4})` }}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 text-white showcase-img" style={{ backgroundImage: `url(${img5})` }}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url(${img6})` }}></div>
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
        ...
        <section className="call-to-action text-white text-center" id="signup" style={{ backgroundImage: `url(${img8})` }}>
            <div className="container position-relative">
                <div className="row justify-content-center">
                    <div className="col-xl-6">
